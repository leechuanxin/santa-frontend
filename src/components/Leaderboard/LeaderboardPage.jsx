          ...
          <div className="card-body w-100 ">
            <div className="row d-flex align-items-center">
              ...
              <div className="d-none d-sm-block col-2 col-md-1">
                <img
                  className="img-fluid"
                  src={`https://avatars.dicebear.com/api/adventurer-neutral/${`${leaderboardUser.userId}-${getHash((leaderboardUser.userId + 23), (typeof leaderboardUser.userAddress === 'string' ? leaderboardUser.userAddress.toLowerCase() : ''))}`}.svg`}
                  alt="This is you!"
                />
              </div>
      ...
      <div className="row d-flex justify-content-center">
        <div className="col-12 col-md-10 col-lg-8 col-xl-6">
          ...
          >
            <img
              className="img-fluid"
              src={`https://avatars.dicebear.com/api/adventurer-neutral/${`${leaderboardTopUser.userId}-${getHash((leaderboardTopUser.userId + 23), (typeof leaderboardTopUser.userAddress === 'string' ? leaderboardTopUser.userAddress.toLowerCase() : ''))}`}.svg`}
              alt="This is you!"
            />
          </Link>
        </div>
                  ...
                  const filteredAllUsers = [...res]
                    .map((filteredUser) => {
                      ...
                      for (let i = 0; i < response.data.users.length; i += 1) {
                        if (
                          typeof filteredUser.userAddress === 'string'
                          && typeof response.data.users[i].walletAddress === 'string'
